...
const createScheduledAuthHttpClient = (): AxiosInstance =>
  axios.create({
...
class SDKServer {
  ...
  constructor(client: AxiosInstance = createScheduledAuthHttpClient()) {
    this.client = client;
  }
  ...
  async authenticateRequest(req: Request): Promise<AuthenticatedUser> {
    // 1. Prefer the phone-password session cookie.
